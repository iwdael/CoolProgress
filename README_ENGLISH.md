...
CustomProgres is a progress display control, it provides three different styles of progressbar, respectively, linear, circular, arc.[中文文档](https://github.com/hacknife/CustomProgress/blob/master/README.md)
## Instruction
