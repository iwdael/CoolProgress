package com.iwdael.coolprogress;
...
public class ArcProgress extends ProgressBar {
    ...
    private final int DEFAULT_mProgressColor = Color.BLACK;
    ...
    public ArcProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mBoardWidth = attributes.getDimensionPixelOffset(R.styleable.ArcProgress_arcborderWidth, DEFAULT_LINEHEIGHT);
        mUnmProgressColor = attributes.getColor(R.styleable.ArcProgress_unprogresColor, DEFAULT_mUnmProgressColor);
        mProgressColor = attributes.getColor(R.styleable.ArcProgress_arcprogressColor, DEFAULT_mProgressColor);
